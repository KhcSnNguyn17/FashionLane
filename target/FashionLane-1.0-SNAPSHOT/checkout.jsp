    ...
    <body>
        ...
        <section class="Checkout_Container">
            <div class="Information_Container">
                ...
                <c:set var="tempAddress" value="${sessionScope.temporaryAddress}" />
                <c:if test="${tempAddress == null}">
                    <div class="Shipping">
                        <div class="Information_Title">
                            <h1>2</h1>
                            <h1>Shipping</h1>
                        ...
                        <form action="Checkout?mod=1" method="post">
                            <select id="CountryID" name="CountryID" required>
                                ...
                                <c:forEach items="${sessionScope.countryList}" var="c">
                                    <option value="${c.countryID}">${c.countryName}</option>
                                </c:forEach>
                            </select>
                            <input id="recipient" value="${acc.firstName} ${acc.lastName}" name="recipient" placeholder="Full Name" type="text" required><br>
                ...
                <c:set var="PayType" value="${sessionScope.PayType}" />
                <c:if test="${PayType == null}">
                    <div class="Your_Email">
                        <div class="Information_Title">
                            <h1>3</h1>
                            <h1>Payment</h1>
            ...
            <div class="Cart_List_Container">
                <div class="Cart_List_Header">
                    <div class="Cart_List_Icon">
                        ...
                        <c:forEach var="item" items="${sessionScope.cartItemList}">
                            <c:forEach var="o" items="${sessionScope.cartItemList2}">
                ...
                <div class="Cart_List">
                    <c:forEach var="ci" items="${cartItemList}">

                        <c:forEach items="${sessionScope.cartItemList2}" var="obj">
                            <c:if test="${obj.getProductID() == ci.getProductID() && obj.getVariationID() == ci.getVariationID()}">
                                <c:set var="o" value="${obj}"/>
                            </c:if>
                        </c:forEach>
                        <c:if test= "${o == null}">
                            o bang null
                        ...
                        <div class="Cart_Item" style="margin-bottom: 20px;">
                            ...
                            <div class="Cart_Item_Content">
                                <div class="Cart_Item_Header">
                                    ...
                                    <c:if test="${tempAddress == null && PayType == null}">
                ...
                <div class="Place_Order_Container">
                    ...
                    <h1 style="color:red; font-family: 'Nunito Sans', sans-serif; font-size: 14px">${PayMessError}</h1>
                    <a class="button" href="${pageContext.request.contextPath}/order?UserID=${acc.getUserID()}">Place Order</a>
                    <a class="button" style="background-color: gray; margin-top: 1rem" href="${pageContext.request.contextPath}/home-servlet">Cancel</a>
                </div>
            </div>
